...
function StarRating({onSetRating, maxRating = 5, color = "orange", size = 25, messages = [], defaultRating = 0 }) {
...
function Star({ onRate, full, onHoverIn, onHoverOut, color, size }) {
  ...
  return (
    <span onMouseEnter={onHoverIn} onMouseLeave={onHoverOut} onClick={onRate} role="button" style={starStyle}>
      {full ? (
